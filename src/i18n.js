...
const resources = {
  ...
  en: {
    translation: {
      ...
      "linux_interest_description": "Manjaro (native KDE) is my preferred OS for development. Currently, I run a dual boot system with Manjaro & Windows 11 on my personal machine.",
  ...
  pt: {
    translation: {
      ...
      "linux_interest_title": "Linux",
      "linux_interest_description": "Manjaro (KDE Plasma) é meu OS preferido para desenvolvimento. Atualmente, uso um sistema de dual boot na minha máquina pessoal com Manjaro & Windows 11.",
